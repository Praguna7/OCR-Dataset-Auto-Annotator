const fmAbayaToUnicode = function(text) {
...
const inputText = process.argv[2]; // Get input from command line arguments
console.log(fmAbayaToUnicode(inputText)); // Output the converted text
